...
class Settings(BaseSettings):
    # Database
    DATABASE_URL: str = "postgresql+asyncpg://gazprom:gazprom_secret@localhost:5432/gazprom_procurement"
    DATABASE_URL_SYNC: str = "postgresql+psycopg2://gazprom:gazprom_secret@localhost:5432/gazprom_procurement"
